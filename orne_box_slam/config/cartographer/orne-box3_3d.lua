...
TRAJECTORY_BUILDER_3D.min_range = 2.5 --4.8
TRAJECTORY_BUILDER_3D.max_range = 150 --100 --150
TRAJECTORY_BUILDER_3D.num_accumulated_range_data = 1 --1
TRAJECTORY_BUILDER_3D.voxel_filter_size = 0.15
TRAJECTORY_BUILDER_3D.imu_gravity_time_constant = 9.81 --9.81
...
TRAJECTORY_BUILDER_3D.motion_filter.max_time_seconds = 0.5 --0.5
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 10 --10--Cost of translating a new scan from the submap.
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight = 4 --4 --Cost of rotating a new scan from the submap. Default=4e2, reccommended=2e1
...
POSE_GRAPH.optimize_every_n_nodes = 90 --100 --90
...
POSE_GRAPH.optimization_problem.acceleration_weight = 750 --750
